...
manifests: ## Generate K8s manifests e.g. CRD, RBAC etc.
	...
	mv ${TMPDIR}/cilium.io_ciliumsrv6egresspolicies.yaml ./pkg/k8s/apis/cilium.io/client/crds/v2alpha1/ciliumsrv6egresspolicies.yaml
	mv ${TMPDIR}/cilium.io_ciliumsrv6vrfs.yaml ./pkg/k8s/apis/cilium.io/client/crds/v2alpha1/ciliumsrv6vrfs.yaml
