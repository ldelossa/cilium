...
func (n *linuxNodeHandler) enableIPSecIPv4DoLocalHost(newNode *nodeTypes.Node, errs error) (bool, error) {
	if newNode.IsLocal() {
...
func (n *linuxNodeHandler) enableIPsecIPv4(newNode *nodeTypes.Node, nodeID uint16, zeroMark, updateExisting bool) (bool, error) {
	...
	var isLocal bool
	if isLocal, errs = n.enableIPSecIPv4DoLocalHost(newNode, errs); isLocal {
		return isLocal, errs
	}
...
//
// 	var ok bool
// 	if ok, errs = n.enableIPSecIPv4DoLocalHost(newNode, errs); ok {
// 		return ok, errs
// 	}
//
// 	if newNode.IsLocal() {
