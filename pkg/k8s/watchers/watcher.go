...
var ciliumResourceToGroupMapping = map[string]watcherInfo{
	...
	synced.CRDResourceName(v2alpha1.CSREPName):   {skip, k8sAPIGroupCiliumSRv6EgressPolicyV2},
	synced.CRDResourceName(v2alpha1.CSRVRFName):  {skip, k8sAPIGroupCiliumSRv6VRFV2},
