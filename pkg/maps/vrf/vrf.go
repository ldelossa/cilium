...
const (
	VRFMapName4   = "cilium_vrf_v4"
	VRFMapName6   = "cilium_vrf_v6"
	MaxVRFEntries = 16384
...
// VRFIterateCallback represents the signature of the callback function
// expected by the IterateWithCallback method, which in turn is used to iterate
// all the keys/values of policy maps.
type VRFIterateCallback func(*VRFKey, *VRFValue)
...
func (m *VRFMap4) IterateWithCallback(cb VRFIterateCallback) error {
...
// map, passing each key/value pair to the cb callback.
func (m *VRFMap6) IterateWithCallback(cb VRFIterateCallback) error {
	return m.DumpWithCallback(func(k bpf.MapKey, v bpf.MapValue) {
		k6 := k.(*VRFKey6)
		key := &VRFKey{
...
// VRFMap is the internal representation of an VRF mapping map.
type VRFMap struct {
	*bpf.Map
}
